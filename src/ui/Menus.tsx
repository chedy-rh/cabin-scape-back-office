...
import type { MenusButtonProps, MenusContextType, Position } from "../types";
...
function Toggle({ id }: { id: number }) {
  ...
  function handleClick(e: React.MouseEvent<HTMLButtonElement>) {
    e.stopPropagation();
    const button = (e.currentTarget as HTMLButtonElement).closest("button")!;
...
function Button({ children, icon, onClick }: MenusButtonProps) {
